...
#define JTAG_TCK ((PIN){   "GPIO1_12",    GPIO1,     44, 	12,	 "gpmc_ad12",     28,    FALSE, 0   })
#define JTAG_TDI ((PIN){   "GPIO1_14",    GPIO1,     46, 	14,	 "gpmc_ad14",     30,    FALSE, 0   })
...
#define JTAG_TMS ((PIN){   "GPIO3_16",    GPIO3,     112, 	16,	 "mcasp0_axr0",       62,    FALSE, 0   })
#define JTAG_TDO ((PIN){   "GPIO3_14",    GPIO3,     110, 	14,	 "mcasp0_aclkx",      65,    FALSE, 0   })
